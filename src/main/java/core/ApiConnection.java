...
public class ApiConnection {
    ...
    /**
     * Connects to and queries Credo API with POST
     *
    ...
    /**
     * Used to send a GET request to the Credo API
     *
    ...
    /**
     * Used to send a PUT request to the Credo API
     *
     * @param query - APIQuery containing parameters to send
     * @return - JSONObject containing API response
     */
